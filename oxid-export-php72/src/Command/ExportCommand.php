...
/**
 * PHP 7.2 / Symfony 5.4 port of the OXID export command. Uses the static
 * $defaultName instead of the #[AsCommand] attribute (PHP 8.0+).
 */
final class ExportCommand extends Command
{
    /** @var string|null */
    protected static $defaultName = 'oxid:export';

    protected function configure(): void
    {
        $this
            ->setDescription('Export OXID 6.3 categories, products, manufacturers, properties, orders & customers to JSON')
            ->addOption('out', 'o', InputOption::VALUE_REQUIRED, 'Output JSON file path', 'oxid-export.json')
            ->addOption('mapping', 'm', InputOption::VALUE_REQUIRED, 'Path to mapping.yaml')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $vatOverride = $input->getOption('default-vat');
        if ($vatOverride !== null) {
        ...
        $io->title('OXID 6.3 -> JSON export (PHP 7.2)');
